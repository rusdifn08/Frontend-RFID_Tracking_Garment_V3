...
const DashboardBundleCutting = lazy(() => import('../pages/DashboardBundleCutting.tsx'));
...
const router = createBrowserRouter([
    ...
    {
        path: '/dashboard-bundle-cutting',
        element: (
            <ProtectedRoute>
                <LazyWrapper>
                    <DashboardBundleCutting />
                </LazyWrapper>
            </ProtectedRoute>
        ),
    },
